...
<div class="gallery" style="margin: 2rem 0;">
    <img src="/images/planktographica/fanyella.png" alt="planctographica" onclick="openLightbox(this.src)">
    <img src="/images/planktographica/IMG_0244.jpg" alt="planctographica" onclick="openLightbox(this.src)">
    <img src="/images/planktographica/IMG_0245.jpg" alt="planctographica" onclick="openLightbox(this.src)">
    <img src="/images/planktographica/IMG_0246.jpg" alt="planctographica" onclick="openLightbox(this.src)">
    <img src="/images/planktographica/IMG_0249.jpg" alt="planctographica" onclick="openLightbox(this.src)">
    <img src="/images/planktographica/IMG_0250.jpg" alt="planctographica" onclick="openLightbox(this.src)">
    <img src="/images/planktographica/IMG_8630.jpg" alt="planctographica" onclick="openLightbox(this.src)">
    <img src="/images/planktographica/IMG_8631.jpg" alt="planctographica" onclick="openLightbox(this.src)">
    <img src="/images/planktographica/IMG_8632.jpg" alt="planctographica" onclick="openLightbox(this.src)">
</div>
